    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm select-none">
      ...
      >
        <div className="p-6 sm:p-8">
          ...
          <label className="mt-4 flex items-start gap-3 text-xs leading-relaxed cursor-pointer">
            <input
              type="checkbox"
              checked={agreed}
            ...
            <span>
              {isAmharic
                ? 'በመረጃ ጥበቃ መርሆቻችን ተስማምቻለሁ። ሙሉ ፖሊሲ፡ docs/PRIVACY.md'
                : 'I agree to Awde’s privacy principles. Full policy: docs/PRIVACY.md'}
            </span>
          </label>
          ...
          <p className="mt-4 text-[11px] leading-relaxed" style={{ color: 'var(--app-text-muted, #475569)' }}>
            {isAmharic
              ? 'ከመለያ ውጪ ምንም ግላዊ መረጃ አንሰበስብም፤ በፈለጉት ጊዜ መለያዎን እና ሁሉንም ውሂብዎን ከሰርቨር፣ ከ Account ቀጥሎ ከ Delete በኩል መሰረዝ ይችላሉ።'
              : 'Beyond a login email, we collect no personal data — and you can erase your account and all server data anytime under Account → Delete.'}
          </p>
        </div>
      </motion.div>
    </div>
